...
CODE_FOLDER="/root/Twitter-Sentiment-Analyzer-Apache-Spark-Mllib"
cd $CODE_FOLDER/
...
spark-submit --class "org.iamShantanu101.spark.SentimentAnalyzer.mllib.SparkNaiveBayesModelCreator" --master spark://spark:7077 mllib-tweet-sentiment-analysis-assembly-0.1.jar
...
cd $CODE_FOLDER/target/scala-2.10/
spark-submit --class "org.iamShantanu101.spark.SentimentAnalyzer.TweetSentimentAnalyzer" --master spark://spark:7077 Twitter-Sentiment-Analyzer--assembly-0.1.jar
